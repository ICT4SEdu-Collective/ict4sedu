...
* **If you are worried about "course-scrapers" selling your work:** Use **CC BY-NC**.

Below is a summary of the most common licenses used for documentation and courses, formatted as a markdown guide.  *ShareAlike*, in legal terms, is a condition that requires any derivative work you create based on the original material to be distributed under the same license as the original.
...
| --- | --- | --- | --- | --- |
| **CC BY 4.0** | ✅ Yes | ✅ Yes | ❌ No | Most flexible; requires attribution only. |
| **CC BY-SA 4.0** | ✅ Yes | ✅ Yes | ✅ Yes | Used by **Wikipedia**. Modifications must stay open. |
| **CC BY-NC 4.0** | ❌ No | ✅ Yes | ❌ No | Great for protecting your work from being sold by others. |
| **CC BY-NC-SA 4.0** | ❌ No | ✅ Yes | ✅ Yes | Common for academic OER (Open Educational Resources). |
| **CC BY-ND 4.0** | ✅ Yes | ❌ No | N/A | Allows sharing, but the document cannot be changed. |
| **CC0 (Public Domain)** | ✅ Yes | ✅ Yes | ❌ No | "No Rights Reserved." You waive all copyright. |
| **GNU FDL** | ✅ Yes | ✅ Yes | ✅ Yes | Designed for software manuals; more complex than CC. |
...
* **Best for:** Technical manuals strictly tied to GNU/Linux software.
